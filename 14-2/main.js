    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire({
                ...
                text: 'Ngày 20/10 luôn là ngày thật đặc biệt với em và cả anh nữa 😊, Vì đó lại thêm ngày anh được yêu thương chăm sóc em. Anh chúc em tràn đầy hạnh phúc ngọt ngào hãy gìn giữ và nuôi dưỡng tình yêu của chúng mình em nhé!🥰🥰🥰',
                imageUrl: 'baner.jpg',
                background: '#fff url("iput-bg.jpg")',
                imageAlt: 'Custom image',
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            ...
                                            Swal.fire({
                                                ...
                                                background: '#fff url("iput-bg.jpg")',
                                                title: 'Chúc bạn một ngày 20/10 vui vẻ không quạo nha🥰😘😘',
